<?php
	...
	$busqueda = "SELECT lec.lec_ExcesoMts3 as Excesomts3,FORMAT(GETDATE() , 'dd/MM/yyyy HH:mm:ss') AS fechaHoy,dbo.ecuentasaldopormes(rec.inm_Id,(CONVERT (date, SYSDATETIME()))) as saldo,  * 
...
//	$pdf->Cell(10,5 , '', 0,1,'L');
	...
	$pdf->Cell(78,7 , '                                      SALDO:    Q.', 0,0,'L' );
	$pdf->Cell(18,7 ,   	number_format("$saldo",2), 0,1,'R');
 	$pdf->Cell(10,5 , '', 0,1,'L');	
	$pdf->SetFont('Arial','',9);
	...
	$pdf->SetFont('Arial','',14);
			$pdf->SetXy(75, 113 );
	$pdf->Cell(25,15,'ATX - 249-278',0,1,'C');
