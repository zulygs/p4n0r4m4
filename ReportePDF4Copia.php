...
//		$fec_pag = "21/ENE/2019";
	...
	$pdf->Image('Logo_ Panorama.jpg', 1, 3, 45 ); 
	$pdf->SetFont('Arial','',8);
	$pdf->SetXy(36, 10 );
...
//		$pdf->SetTextColor (255,255,255);
	...
	$pdf->Cell(10,4 , '', 0,1,'L');
		...
		$pdf->SetX(3);
		$pdf->SetFillColor(223, 248, 249);
	$pdf->Cell(35,6 , 'Lectura Anterior: ', 0,0,'L',True);
...
//	$pdf->Cell(23,7 , number_format("$total_1",2), 0,1,'R');
	...
	$pdf->SetTextColor (0,0,0);
		$pdf->SetX(3);
	$pdf->Image('Logo_banrural.png', 3, 104, 38 ); 
	$pdf->SetFont('Arial','',14);
			$pdf->SetXy(50, 119 );
	$pdf->Cell(25,7,'ATX - 249-278',0,1,'C');
			$pdf->SetXy(3,130);
	$pdf->Cell(120,4,'--------------------------------------------------------------------',0,1,'C');
	$pdf->Image('Logo_ Panorama.jpg', 1, 133, 40 ); 
	$pdf->SetFont('Arial','',8);
		$pdf->SetXy(36, 135 );
	$pdf->Cell(80,4.5 , 'ASOCIACION DE VECINOS COLONIA PANORAMA', 0,0,'C');
	$pdf->SetFont('Arial','',8);
...
//	$pdf->Cell(110,4.5, utf8_decode("$leyenda_"),0,1, 'C');
	...
	$pdf->SetTextColor (0,0,0);
		$pdf->SetX(3);
	$pdf->Image('Logo_banrural.png', 3, 190, 30 ); 
	$pdf->SetFont('Arial','',14);
		//	$pdf->SetXy(3, 119 );
	//$pdf->Cell(25,7,'ATX - 249-278',0,1,'C');
