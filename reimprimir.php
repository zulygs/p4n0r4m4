          ...
          <div class="container-fluid">
            <div class="header-body" >
              <div class="container container-form-med">
                <form  method="POST" action="ReportePDF2.php">
                  <h2>Imprimir Reposición Recibos Canon de Agua PANORAMA</h2>
                  <div class="form-group " >
                    ...
                    <select name='mes' class="form-control selectpicker">
                      ...
                      $Consulta = "SELECT  top 12 mes_Nombre,mes_id,year(mes_FechaInicio) as ano
