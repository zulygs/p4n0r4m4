...
//$userr     = $_SESSION['user'];
    ...
    where rec.mes_id = '$mes___'  and lec.mes_Id = '$mes___' and inm_idGenerado like '%$inm_id_b_%'";
        ...
        while ($fila2 = sqlsrv_fetch_array($buscar)) {
            ...
            $pdf->SetFont('Arial', '', 9);
            $pdf->Cell(190, -217, utf8_decode("$leyenda_"), 0, 1, 'C');
          ...
          <div class="panel-header panel-header-lg" >
            <div class="container container-form-lg"  >
              <div class="col-md-12 ">
                ...
                <form class="needs-validation" novalidate method="POST" action="Correo1.php?inm_id_b=<?php echo $inm_id_b_; ?>& mes__=<?php echo $mes___; ?>">
                  <center>
