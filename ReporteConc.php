          ...
          <div class="container-fluid">
            <div class="header-body" >
              <div class="container container-form-med">
                <form  method="POST" action="MedidorT.php">
                  <h2>Imprimir Conceptos PANORAMA</h2>
                  <div class="form-group " >
                    
                    <h3>Concepto a Imprimir:</h3>
                    <select name='Concepto' class="form-control selectpicker">
                      <?php
                      include 'conexion.php';
                      $con      = sqlsrv_connect($serverName, $connectionInfo) or die('Error en el Servidor');
                      $Consulta = "SELECT * from [CONTROLTOTAL(PANORAMA)].dbo.agu_ConceptosLecturas";
                  ...
                  <div class="form-group">
                    <a href="MedidorT2.php" type="button" class="btn btn-primary btn-lg btn-block" style="width: 150px">Imprimir todo</a><br>
                  </div>
                </form>
              </div>
            </div>
