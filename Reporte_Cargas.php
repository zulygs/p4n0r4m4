      ...
      <center>
        <div class="header bg-gradient-primary pb-9 pt-5 pt-md-7" id="lateral">
          <div class="container-fluid">
            <div class="header-body" >
              <div class="container container-form-med">
                <form  method="POST" action="TablaCargas.php">
         ...
         ?>
            ...
            <div> <input type="month" name="fecha" id="fecha" style="width: 250px" class="form-control" value="<?php echo($calendario) ?>" ></div>
          </div>
                  </div>
                  <br>
                  <div class="form-group">
                    <input type="submit" id="click" name="inserta" class="btn btn-primary btn-lg btn-block" value="Consultar"><br>
                  </div>
                </form>
              </div>
            </div>
