          ...
          <div class="panel-header panel-header-lg" id="lateral">
            <div class="container container-form-lg">
              <div class="col-md-12">
                ...
                <form class="needs-validation" id="tuformulario" name="tuformulario" novalidate method="POST" action="VisualCorreoCargas.php">
                  
                  <div class="form-group">
                    
                    <input type="" id="click" name= "correo123"  onclick="pregunta()" class="btn btn-primary " style="width: 250px" value= "Continuar" >
                  </div>
                </form>
              </div>
            </div>
...
function pregunta(){
    if (confirm('Este correo Será enviado con la carga al banco Banrural ¿Desea Continuar?')){
