          ...
          <div class="container-fluid">
            <div class="header-body" >
              ...
              <div class="container container-form-med">
                <form  method="POST" action="ReportePDF4Copia.php" >
                  <h2>Imprimir Recibos Recibos Canon de Agua PANORAMA</h2>
                  <div class="form-group " >
                    ...
                    <select name="mes" class="form-control selectpicker">
                      ...
                      $Consulta="SELECT  top 2 mes_Nombre,mes_id,year(mes_FechaInicio) as ano FROM pdv_CiclosMeses where mes_id <= (select pro_mes from agu_Procesos where pro_id=2 )
